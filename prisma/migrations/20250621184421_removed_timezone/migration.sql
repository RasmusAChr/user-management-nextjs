...
INSERT INTO "new_User" ("ageConfirmed", "bio", "country", "createdAt", "email", "emailVerified", "firstName", "gender", "id", "isOnline", "language", "lastFailedLogin", "lastLogin", "lastName", "lastSeen", "locked", "lockedAt", "loginAttempts", "passwordChangedAt", "passwordHash", "phoneNumber", "privacyPolicyAcceptedAt", "resetToken", "resetTokenExpiry", "roleId", "status", "teamId", "termsAcceptedAt", "twoFactorEnabled", "updatedAt", "userImageURI", "username", "website") SELECT "ageConfirmed", "bio", "country", "createdAt", "email", "emailVerified", "firstName", "gender", "id", "isOnline", "language", "lastFailedLogin", "lastLogin", "lastName", "lastSeen", "locked", "lockedAt", "loginAttempts", "passwordChangedAt", "passwordHash", "phoneNumber", "privacyPolicyAcceptedAt", "resetToken", "resetTokenExpiry", "roleId", "status", "teamId", "termsAcceptedAt", "twoFactorEnabled", "updatedAt", "userImageURI", "username", "website" FROM "User";
DROP TABLE "User";
